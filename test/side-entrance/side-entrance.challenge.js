...
describe("[Challenge] Side entrance", function () {
  ...
  it("Execution", async function () {
    const exploiter = await ethers.getContractFactory("SideEntranceExploiter");
    const exploiterContract = await exploiter.deploy(pool.address);
    await exploiterContract.connect(player).exploit();
  });
